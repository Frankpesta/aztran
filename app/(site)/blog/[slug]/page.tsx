    ...
    <article className="pb-section pt-28">
      ...
      {coverUrl ? (
        <div className="mx-auto mt-10 max-w-[900px] px-4">
          <div className="relative aspect-[16/9] overflow-hidden rounded-2xl border border-[color-mix(in_srgb,var(--color-silver)_35%,transparent)] bg-[color-mix(in_srgb,var(--color-offwhite)_92%,var(--color-white))] dark:bg-[color-mix(in_srgb,var(--color-navy)_94%,black)]">
            <ConvexStorageImage
              src={coverUrl}
              alt=""
          ...
          >
            ...
            {imgUrl ? (
              <figure className="mt-10">
                <div className="relative aspect-[16/10] overflow-hidden rounded-xl border border-[color-mix(in_srgb,var(--color-silver)_35%,transparent)] bg-[color-mix(in_srgb,var(--color-offwhite)_92%,var(--color-white))] dark:bg-[color-mix(in_srgb,var(--color-navy)_94%,black)]">
                  <ConvexStorageImage
                    src={imgUrl}
